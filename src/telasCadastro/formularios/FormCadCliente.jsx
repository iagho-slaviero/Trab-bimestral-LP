...
export default function FormCadCliente(props) {
    ...
    function manipularSubmissao(e){
        ...
        if (form.checkValidity()){
            const verificaCPF  = props.listaClientes.find((itemCliente) => itemCliente.cpf === cliente.cpf);
            if(!props.modoEdicao){
                if(verificaCPF){
            ...
            if(props.modoEdicao === false){
                if(verificaCPF){
                    setMensagemSucesso("Cliente já cadastrado!");
                ...
                setMensagemSucesso("Validação realizada com sucesso!");
                setExibirMensagem(true);
            }
        }
        else{
